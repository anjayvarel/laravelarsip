...
@section('content')
    <div class="container-fluid">
       ...
       <div class="row mb-3">
        <!-- Filter Kategori -->
        <div class="col-md-6">
            <form action="{{ route('staff.surat.keluar') }}" method="GET">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th><a href="{{ route('staff.surat.keluar', array_merge(request()->all(), ['sort_by' => 'no_surat', 'sort_order' => request('sort_order') == 'asc' ? 'desc' : 'asc'])) }}">No Surat</a></th>
                                <th><a href="{{ route('staff.surat.keluar', array_merge(request()->all(), ['sort_by' => 'pengirim', 'sort_order' => request('sort_order') == 'asc' ? 'desc' : 'asc'])) }}">Pengirim</a></th>
                                <th>Kategori</th>
                                <th>Tanggal Surat</th>
