...
@endif
    ...
    <div>
        <p class=" my-1 text-muted fw-8">Selamat Datang, <strong>{{ Auth::user()->nama }}</strong></p>
    </div>
    ...
    <div class="card shadow-lg mt-4 rounded">
        <div class="card-body">
            <h5 class="card-title font-weight-bold">Cetak Laporan Surat</h5>
            <div class="fw-bold">
                <p>Surat Dicetak Berdasarkan Tanggal Surat Diterima/Dibuat</p>
            </div>
            <form action="{{ route('staff.surat.cetak') }}" method="GET" target="_blank">
                <div class="row">
